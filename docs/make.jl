...
DocMeta.setdocmeta!(BifurcationForecasting, :DocTestSetup, :(using BifurcationForecasting); recursive = true)
...
makedocs(;
    ...
    repo = "https://github.com/dawbarton/BifurcationForecasting.jl/blob/{commit}{path}#{line}",
